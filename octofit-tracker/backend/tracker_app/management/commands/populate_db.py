...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        print("Inserted users:", User.objects.count())
        ...
        print("Inserted teams:", Team.objects.count())
        ...
        print("Inserted activities:", Activity.objects.count())
        ...
        print("Inserted leaderboard entries:", Leaderboard.objects.count())
        ...
        workouts = [
            ...
            Workout(_id=ObjectId(), name='Cycling Challenge', description='15km cycling challenge'),
        ]
        Workout.objects.bulk_create(workouts)
        print("Inserted workouts:", Workout.objects.count())
